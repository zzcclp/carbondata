...
public class BlockletBTreeLeafNode extends AbstractBTreeLeafNode {
   ...
   */
  @Override
  public DimensionRawColumnChunk[] readDimensionChunks(FileReader fileReader,
   ...
   */
  @Override
  public DimensionRawColumnChunk readDimensionChunk(FileReader fileReader, int chunkIndex)
      throws IOException {
    if (fileReader.isReadPageByPage()) {
      return dimensionChunksPageLevelReader.readRawDimensionChunk(fileReader, chunkIndex);
    } else {
      return dimensionChunksReader.readRawDimensionChunk(fileReader, chunkIndex);
    }
  }
   ...
   */
  @Override
  public MeasureRawColumnChunk[] readMeasureChunks(FileReader fileReader,
      int[][] columnIndexRange) throws IOException {
    if (fileReader.isReadPageByPage()) {
