...
public class CompressedDimensionChunkFileBasedReaderV3 extends AbstractChunkReaderV2V3Format {
  ...
  DimensionRawColumnChunk getDimensionRawColumnChunk(FileReader fileReader, int columnIndex,
      long offset, int length, ByteBuffer buffer, DataChunk3 dataChunk) {
  ...
  DimensionColumnPage decodeDimension(DimensionRawColumnChunk rawColumnPage, ByteBuffer pageData,
      DataChunk2 pageMetadata, int offset)
      throws IOException, MemoryException {
